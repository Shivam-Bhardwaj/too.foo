...
export function DataOverlay({
  ...
  return (
    <div className="fixed top-4 right-4 text-white">
      {/* Main data panel */}
      <div className="bg-gray-900/90 backdrop-blur-sm rounded-lg shadow-xl p-4 w-80">
      ...
      {showDetails && (
        <div className="bg-gray-900/90 backdrop-blur-sm rounded-lg shadow-xl p-4 w-80 mt-4">
          <h2 className="text-lg font-semibold mb-3 border-b border-gray-700 pb-2">
            Solar Wind @ 1 AU
          </h2>
